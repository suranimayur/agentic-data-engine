"""
Database Seeder — Intelligent Multi-Agent Data Engineering Platform
===================================================================
Creates the PostgreSQL schema and loads CSV data into the database.

This script:
1. Connects to PostgreSQL using .env credentials
2. Creates all tables (users, vehicles, rides, payments, ratings)
3. Creates performance indexes
4. Truncates existing data (clean slate)
5. Loads CSV files using PostgreSQL COPY (bulk insert)
6. Verifies record counts
